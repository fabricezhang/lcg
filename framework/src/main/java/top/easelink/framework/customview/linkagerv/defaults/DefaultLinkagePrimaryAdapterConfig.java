package top.easelink.framework.customview.linkagerv.defaults;
/*
...
public class DefaultLinkagePrimaryAdapterConfig implements ILinkagePrimaryAdapterConfig {
    ...
    public void onBindViewHolder(LinkagePrimaryViewHolder holder, boolean selected, String title) {
        ...
        tvTitle.setBackgroundColor(mContext.getResources().getColor(selected ? R.color.black_effective : R.color.white));
        tvTitle.setTextColor(ContextCompat.getColor(mContext, selected ? R.color.white : R.color.black_effective));
